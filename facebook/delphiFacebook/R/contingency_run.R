...
set_aggs <- function() {
  weekly_aggs <- tribble(
    ...
    "pct_vaccinated", "b_had_cov_vaccine", c("mc_age", "mc_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    "pct_vaccinated_or_accepting", "v_covid_vaccinated_or_accept", c("mc_age", "mc_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    "pct_vaccinated", "b_had_cov_vaccine", c("b_65_or_older", "mc_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    "pct_vaccinated_or_accepting", "v_covid_vaccinated_or_accept", c("b_65_or_older", "mc_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    
    "pct_vaccinated", "b_had_cov_vaccine", c("mc_age", "mc_race_ethnicity", "state"), compute_binary, jeffreys_binary,
    "pct_vaccinated_or_accepting", "v_covid_vaccinated_or_accept", c("mc_age", "mc_race_ethnicity", "state"), compute_binary, jeffreys_binary,
    "pct_vaccinated", "b_had_cov_vaccine", c("b_65_or_older", "mc_race_ethnicity", "state"), compute_binary, jeffreys_binary,
    "pct_vaccinated_or_accepting", "v_covid_vaccinated_or_accept", c("b_65_or_older", "mc_race_ethnicity", "state"), compute_binary, jeffreys_binary,
  )
