...
set_aggs <- function() {
  ...
  monthly_aggs <- tribble(
    ...
    # "pct_vaccinated_2", "b_vaccinated", c("nation"), compute_binary, jeffreys_binary,
    ...
    # "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("nation"), compute_binary, jeffreys_binary,
    # 
    ...
    # 
    # "pct_hesitant_sideeffects", "b_concerned_sideeffects", c("nation", "b_hesitant_cov_vaccine"), compute_binary, jeffreys_binary,
    # "pct_hesitant_trust_fam", "b_vaccine_likely_friends", c("nation", "b_hesitant_cov_vaccine"), compute_binary, jeffreys_binary,
    # "pct_hesitant_trust_healthcare", "b_vaccine_likely_local_health", c("nation", "b_hesitant_cov_vaccine"), compute_binary, jeffreys_binary,
    # "pct_hesitant_trust_who", "b_vaccine_likely_who", c("nation", "b_hesitant_cov_vaccine"), compute_binary, jeffreys_binary,
    # "pct_hesitant_trust_govt", "b_vaccine_likely_govt_health", c("nation", "b_hesitant_cov_vaccine"), compute_binary, jeffreys_binary,
    # "pct_hesitant_trust_politicians", "b_vaccine_likely_politicians", c("nation", "b_hesitant_cov_vaccine"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("state"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "v_covid_vaccinated", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "v_covid_vaccinated", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "v_covid_vaccinated", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    "pct_not_vaccinated_and_accepting", "b_not_vaccinated_and_accepting", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    "pct_not_vaccinated_and_hesitant", "b_not_vaccinated_and_hesitant", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_age", "mc_gender", "mc_CDC_race_ethnicity", "b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_age", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_gender", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "v_covid_vaccinated", c("mc_CDC_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("mc_CDC_race_ethnicity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "v_covid_vaccinated", c("b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    "pct_not_vaccinated_and_accepting", "b_not_vaccinated_and_accepting", c("b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    "pct_not_vaccinated_and_hesitant", "b_not_vaccinated_and_hesitant", c("b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_any_comorbidity_preg_smoke_obese", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_heart_disease", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_cancer", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_chronic_kidney_disease", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_chronic_lung_disease", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_diabetes", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_not_vaccinated_and_did_not_indicate_hesitance_level", "b_not_vaccinated_and_did_not_indicate_hesitance_level", c("b_immunocompromised", "nation"), compute_binary, jeffreys_binary,
