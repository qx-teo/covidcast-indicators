...
set_aggs <- function() {
  ...
  monthly_aggs <- tribble(
    ...
    "pct_hesitancy_reason_sideeffects", "v_hesitancy_reason_sideeffects", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_allergic", "v_hesitancy_reason_allergic", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_ineffective", "v_hesitancy_reason_ineffective", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_unnecessary", "v_hesitancy_reason_unnecessary", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_dislike_vaccines", "v_hesitancy_reason_dislike_vaccines", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_not_recommended", "v_hesitancy_reason_not_recommended", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_wait_safety", "v_hesitancy_reason_wait_safety", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_low_priority", "v_hesitancy_reason_low_priority", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_cost", "v_hesitancy_reason_cost", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_distrust_vaccines", "v_hesitancy_reason_distrust_vaccines", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_distrust_gov", "v_hesitancy_reason_distrust_gov", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_health_condition", "v_hesitancy_reason_health_condition", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_other", "v_hesitancy_reason_other", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_pregnant", "v_hesitancy_reason_pregnant", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitancy_reason_religious", "v_hesitancy_reason_religious", c("mc_age", "mc_gender", "nation"), compute_binary, jeffreys_binary,
