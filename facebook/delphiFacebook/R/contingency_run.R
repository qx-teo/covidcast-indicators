...
set_aggs <- function() {
  ...
  monthly_aggs <- tribble(
    ~name, ~metric, ~group_by, ~compute_fn, ~post_fn,
    "pct_appointment_have", "b_appointment_have", c("mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_appointment_have", "b_appointment_have", c("mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_appointment_have", "b_appointment_have", c("mc_hispeth", "county"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_hispeth", "county"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_hispeth", "county"), compute_binary, jeffreys_binary,
    
    "pct_appointment_have", "b_appointment_have", c("mc_age3", "mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_age3", "mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_age3", "mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_appointment_have", "b_appointment_have", c("mc_age3", "mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_age3", "mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_age3", "mc_hispeth", "state"), compute_binary, jeffreys_binary,
    
    "pct_appointment_have", "b_appointment_have", c("mc_gender", "mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_gender", "mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_gender", "mc_hispeth", "nation"), compute_binary, jeffreys_binary,
    "pct_appointment_have", "b_appointment_have", c("mc_gender", "mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_appointment_tried", "b_appointment_tried", c("mc_gender", "mc_hispeth", "state"), compute_binary, jeffreys_binary,
    "pct_vaccination_informed", "b_vaccination_informed", c("mc_gender", "mc_hispeth", "state"), compute_binary, jeffreys_binary,
