...
set_aggs <- function() {
  ...
  indicators <- tribble(
    ...
    "pct_cli", "n_hh_prop_cli", compute_numeric, jeffreys_count,
    "pct_vaccinated", "v_covid_vaccinated", compute_binary, jeffreys_binary,
    "pct_accept_vaccine", "b_accept_cov_vaccine", compute_binary, jeffreys_binary,
  ...
  aggs <- list("week"=aggs, "month"=aggs)
