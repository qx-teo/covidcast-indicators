...
set_aggs <- function() {
  ...
  monthly_aggs <- tribble(
    ...
    "pct_twodoses", "b_received_2_vaccine_doses", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "b_had_cov_vaccine", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_twodoses", "b_received_2_vaccine_doses", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_accepting", "b_accept_cov_vaccine", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_concerned_sideeffects", "b_concerned_sideeffects", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_sideeffects", "b_hesitant_sideeffects", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_fam", "b_hesitant_trust_fam", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_healthcare", "b_hesitant_trust_healthcare", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_who", "b_hesitant_trust_who", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_govt", "b_hesitant_trust_govt", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_politicians", "b_hesitant_trust_politicians", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_fam", "b_vaccine_likely_friends", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_healthcare", "b_vaccine_likely_local_health", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_who", "b_vaccine_likely_who", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_govt", "b_vaccine_likely_govt_health", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_politicians", "b_vaccine_likely_politicians", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_work_in_healthcare", "nation"), compute_binary, jeffreys_binary,
    
    "pct_vaccinated", "b_had_cov_vaccine", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_twodoses", "b_received_2_vaccine_doses", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_accepting", "b_accept_cov_vaccine", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_concerned_sideeffects", "b_concerned_sideeffects", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_sideeffects", "b_hesitant_sideeffects", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_fam", "b_hesitant_trust_fam", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_healthcare", "b_hesitant_trust_healthcare", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_who", "b_hesitant_trust_who", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_govt", "b_hesitant_trust_govt", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_hesitant_trust_politicians", "b_hesitant_trust_politicians", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_fam", "b_vaccine_likely_friends", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_healthcare", "b_vaccine_likely_local_health", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_who", "b_vaccine_likely_who", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_govt", "b_vaccine_likely_govt_health", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_politicians", "b_vaccine_likely_politicians", c("mc_age", "mc_gender", "mc_race", "b_hispanic", "b_any_comorbidity", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_vaccinated", "b_had_cov_vaccine", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    "pct_twodoses", "b_received_2_vaccine_doses", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    ...
    "pct_trust_fam", "b_vaccine_likely_friends", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_healthcare", "b_vaccine_likely_local_health", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_who", "b_vaccine_likely_who", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_govt", "b_vaccine_likely_govt_health", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
    "pct_trust_politicians", "b_vaccine_likely_politicians", c("mc_race", "b_hispanic", "nation"), compute_binary, jeffreys_binary,
